...
Description: Trading strategy performance analyst. Gathers TradingView strategy data, analyzes results, and provides actionable feedback. Use when reviewing back-test results.
Model: sonnet
Tools: "*"
---
...
2. `data_get_trades` - get recent trades list.
...
- **Profitability**: Net profit, profit factor, average trades.
